...
description: '언리얼 엔진으로 알아보는 벡터'
tags: [GameMath, Vector]
category: 'Math'
draft: false
---
...
![axis](./FindingDirection/axis.png)
...
![vector of two](./FindingDirection/포워드벡터와속도벡터.gif)
