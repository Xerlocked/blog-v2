...
![이미지](./SliceSkeletal/s.gif)

---

# 마무리

SliceMesh는 __병렬 처리__를 통한 신속한 버텍스 선별, __비동기 방식__의 안전한 런타임 메시 생성, 그리고 __CPU 스키닝__을 이용한 동적인 절단면 처리과정을 통해 런타임 스켈레탈 메시 절단이라는 과제를 해결했습니다.