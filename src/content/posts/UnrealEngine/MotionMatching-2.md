...
description: '차세대 애니메이션 시스템 모션매칭에 대해 알아봅니다.'
image: './img/cover.png'
tags: [Animation, MotionMatching]
...
![PSDViewer](./MotionMatching/PSDViewer.png)
...
![PoseHistory](./MotionMatching/PoseHistory.png)
...
![PoseHistoryProperty](./MotionMatching/PoseHistoryProperty.png)
_Generate Trajectory 옵션 활성화_

> 5.6 이전 버전을 이용할 경우, 캐릭터 블루프린트에서 CharacterTrajectoryComponent를 추가하고 해당 값을 넘겨주면 됩니다.
...
![모션에러1](./MotionMatching/모션에러1.gif)

현재까지 진행상황으로 캐릭터를 움직여보았습니다. 위와 같이 움직임에서 어색한 부분을 찾을 수 있습니다.

### 리와인드 디버거

![Tools](./MotionMatching/리와인드디버거Tools.png)
