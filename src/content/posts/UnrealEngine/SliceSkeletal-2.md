...
published: 2025-08-20 00:00:02
description: 'Fab 출시를 위한 언리얼 플러그인 제작일지'
tags: [uplugin, Fab]
...
![이미지](./SliceSkeletal/cap.jpg)
_새롭게 생성된 붉은 캡(Cap)_

이 과정은 __SliceSkinnedProceduralMesh__함수 내부에서 체계적으로 이루어집니다. 이 함수는 기존 언리얼 엔진의 __SliceProceduralMesh__함수를 가져와 몇 가지 코드를 추가하였는데요.
...
![이미지](./SliceSkeletal/polygon.gif)
_끊어진 부분 없이 정점이 이어진 모양(closed)_
